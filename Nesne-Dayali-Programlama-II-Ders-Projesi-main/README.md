...
Bu proje, Nesneye Yönelik Programlama (OOP) dersi kapsamında geliştirilmiş Java tabanlı bir konsol uygulamasıdır. Sistem; JDBC ve SQLite kullanarak kalıcı veri yönetimi sağlar ve bir kütüphanedeki temel işlemlerin (kitap, öğrenci, ödünç alma) dijital olarak yönetilmesini amaçlar.
